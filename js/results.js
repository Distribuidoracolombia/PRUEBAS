...
function sendResultsByEmail() {
    try {
        ...
        const emailParams = {
            ...
            cc: "auxiliargh@luma.com.co", // Puedes añadir correos en copia si lo necesitas
        ...
        // Enviar el correo y retornar la promesa explícitamente
        return emailjs.send('service_gu2z3bu', 'template_nh327cj', emailParams)
            .then(function(response) {
                ...
                return response; // Asegurarse de retornar la respuesta
            })
            .catch(function(error) {
                console.log('FAILED...', error);
                alert('Error al enviar resultados por correo: ' + error);
                throw error; // Re-throw para ser capturado por el llamador
            });
    } catch (error) {
        // En caso de error antes de enviar el correo
        console.error("Error preparando el correo:", error);
        alert('Error preparando el correo: ' + error);
